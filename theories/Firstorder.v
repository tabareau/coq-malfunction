...
Proof.
  ...
  Lemma verified_malfunction_pipeline_theorem `{Heap} `{Pointer} `{WcbvFlags} `{EWellformed.EEnvFlags} (cf := extraction_checker_flags)
  univ retro univ_decl kn mind
  (Hparam : ind_params mind = [])
  (Hindices : Forall (fun ind => ind_indices ind = []) (ind_bodies mind))
  (Hnparam : ind_npars mind = 0)
  ...
  Lemma verified_named_erasure_pipeline_fo `{Heap} `{Pointer} `{WcbvFlags} `{EWellformed.EEnvFlags} (cf := extraction_checker_flags)
  univ retro univ_decl kn mind
  (Hparam : ind_params mind = [])
  (Hindices : Forall (fun ind => ind_indices ind = []) (ind_bodies mind))
  (Hnparam : ind_npars mind = 0)
  ...
  Proof.
    ...
    simpl in Heval', Hfo'. sq. rewrite compile_value_mf_eq in Heval'.  
